...
const SITE_DATA = {
  ...
  /* ----------------------------------------------------------
     ...
     card). Fields:
       ...
       dayByDay     - optional array for a full day-by-day breakdown
                       with photos, auto-filled by import_trips.py.
                       Each entry: { date, title, description, photos }.
                       If present, this replaces the plain "images"
                       gallery on the trip page with a day-by-day one.
